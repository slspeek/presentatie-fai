...
\end{itemize}
\onslide<7->{Zie voor meer details de \href{https://fai-project.org/fai-guide/\#_a_id_c3_a_the_configuration_space_and_its_subdirectories}{FAI Guide over de configuratie}}
\end{frame}
