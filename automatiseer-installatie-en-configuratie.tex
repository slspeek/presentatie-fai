...
%Title page
\title[Automatiseer installatie en configuratie] %optional
...
\begin{itemize}
  ...
  \end{itemize}
  \item FAI Installatie live systemen
  \begin{itemize}
    \item \texttt{nfsroot}
  \end{itemize}
...
\end{verbatim} 
  \end{itemize}
\end{frame}
\section{Classes nader bezien}
\begin{frame}
\frametitle{Classes nader bezien}
De volgorde van de classes is belangrijk:
\begin{itemize}
  \item<2-> Eerst de afhankelijkheden   
  \item<3-> Bij meerdere files van verschillende classes, bepaalt de volgorde welke file het wordt. De laatste wint. Zie \href{https://fai-project.org/doc/man/fcopy.html}{\texttt{man fcopy}}
  \item<4-> Bij variabelen geldt hetzelfde
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item \texttt{Makefile} en scripts om snel aan de slag te kunnen
    \begin{itemize}
      \item Installeer FAI
      \item Maak een NFS root
...
\begin{itemize}
  ...
  \end{itemize}
  \item \href{https://github.com/slspeek/fai-cmds/}{Mijn FAI commando's} om snel aan de slag te kunnen
  \end{itemize}
\end{frame}
...
\frametitle{Demo}
\begin{itemize}
  \item Demo van FAI \texttt{live-simpel.iso} in \texttt{libvirt}
  \item Boot van \texttt{live-gnome-compleet.iso}
  \item Installatie van \texttt{gnome-minimaal} profiel
\end{itemize}
\end{frame}
